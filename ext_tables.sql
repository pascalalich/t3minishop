#
# Table structure for table 'tx_t3minishop_domain_model_order'
#
CREATE TABLE tx_t3minishop_domain_model_order (
...
#
# Table structure for table 'tx_t3minishop_domain_model_product'
#
CREATE TABLE tx_t3minishop_domain_model_product (
...
#
# Table structure for table 'tx_t3minishop_domain_model_contact'
#
CREATE TABLE tx_t3minishop_domain_model_contact (
