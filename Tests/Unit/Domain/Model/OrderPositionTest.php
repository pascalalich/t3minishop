...
/**
 * Test case for class \TYPO3\T3minishop\Domain\Model\OrderPosition.
 *
 * @version $Id$
...
class OrderPositionTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var \TYPO3\T3minishop\Domain\Model\OrderPosition
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new \TYPO3\T3minishop\Domain\Model\OrderPosition();
	}
