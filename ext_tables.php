...
$TCA['tx_t3minishop_domain_model_order'] = array(
	'ctrl' => array(
		...
		'searchFields' => 'comment,positions,buyer,',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('tx_t3minishop_domain_model_contact', 'EXT:t3minishop/Resources/Private/Language/locallang_csh_tx_t3minishop_domain_model_contact.xlf');
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::allowTableOnStandardPages('tx_t3minishop_domain_model_contact');
$TCA['tx_t3minishop_domain_model_contact'] = array(
	'ctrl' => array(
		'title'	=> 'LLL:EXT:t3minishop/Resources/Private/Language/locallang_db.xlf:tx_t3minishop_domain_model_contact',
		'label' => 'name',
		'tstamp' => 'tstamp',
		'crdate' => 'crdate',
		'cruser_id' => 'cruser_id',
		...
		'searchFields' => 'name,address,city,email,telephone,',
		'dynamicConfigFile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath($_EXTKEY) . 'Configuration/TCA/Contact.php',
		'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($_EXTKEY) . 'Resources/Public/Icons/tx_t3minishop_domain_model_contact.gif'
	),
);
